...
<link href="resources/css/public/ingredientFooter.css"  rel="stylesheet"  type="text/css">
<script src="resources/js/public/ingredientFooter.js"></script>
...
<div class="contentsBox01 MOB">
    <div class="web_container container01">
        <div class="order_caution danger_caution">
            <div class="acc_tit">
                <h2 class="tit">유의사항</h2><button type="button" class="btn_acc"><span>contents show/hide</span></button>
            </div>
            <div class="acc_cont">
                <ul class="txtlist01">
                    <li>매장별 주문금액이 상이하니, 반드시 최소금액을 확인하기 바랍니다.</li>
...
<jsp:include page="ingredientPopup.jsp" />